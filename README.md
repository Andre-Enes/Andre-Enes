...
- Um Serious Game feito para ensinar equações de primeiro grau para crianças do fundamental 2.
- Desde um tutorial até mais 3 outras fases, em que deve-se montar as equações de forma correta para entregar o valor correto de sementes para os seus clientes. Caso você entregue a quantidade errada de sementes 3 vezes, a fase será encerreda, mas com o objetivo de te motivar a continuar tentando, com foco em ensinar sem focar no erro do aluno.
